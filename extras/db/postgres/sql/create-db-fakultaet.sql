...
-- (5) 2. PowerShell:
--     docker compose exec db bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-fakultaet.sql
--        psql --dbname=fakultaet --username=fakultaet --file=/sql/create-schema-fakultaet.sql
--        exit
--      docker compose down
...
CREATE ROLE fakultaet LOGIN PASSWORD 'p';

-- https://www.postgresql.org/docs/current/sql-createdatabase.html
CREATE DATABASE fakultaet;

-- https://www.postgresql.org/docs/current/sql-grant.html
GRANT ALL ON DATABASE fakultaet TO fakultaet;

-- https://www.postgresql.org/docs/10/sql-createtablespace.html
CREATE TABLESPACE fakultaetspace OWNER fakultaet LOCATION '/var/lib/postgresql/tablespace/fakultaet';
