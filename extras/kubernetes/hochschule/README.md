...
| Name | Email | Url |
| ---- | ------ | --- |
| Ahmad Hawarnsh | <ahmad.hawarnah@test.de> | <https://www.h-ka.de> |
...
| datasource.url | string | `"jdbc:postgresql://localhost/hochschule"` |  |
| datasource.username | string | `"hochschule"` |  |
...
| image.name | string | `"hochschule"` | Name des Image |
